...
public class DepartureTableRenderer {
    ...
    private static int[] departureDetailLengths(List<TrainDeparture> departures, boolean header) {
        ...
        final int MIN_TIME_LENGTH = 3;
        final int MIN_LINE_LENGTH = 1;
        final int MIN_DESTINATION_LENGTH = 10;
        final int MIN_TRAIN_NUMBER_LENGTH = 4;
        final int MIN_TRACK_NUMBER_LENGTH = 2;
        final int MIN_DELAY_LENGTH = 1;

        // Set minimum lengths for each column
        lengths[0] = MIN_TIME_LENGTH;
        lengths[1] = MIN_LINE_LENGTH;
        lengths[2] = MIN_DESTINATION_LENGTH;
        lengths[3] = MIN_TRAIN_NUMBER_LENGTH;
        lengths[4] = MIN_TRACK_NUMBER_LENGTH;
